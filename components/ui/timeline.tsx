      ...
      <RevealOnScroll>
        ...
        >
          <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
            <h2 className="text-lg md:text-4xl mb-4 text-gray-100 max-w-4xl font-bold underline decoration-blue-400">
              ABOUT ME
            </h2>
            <p className="text-neutral-300 text-sm md:text-base max-w-sm">
              I graduated from Arkansas State University and I&apos;m currently
          ...
          <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
            {data.map((item, index) => (
              ...
              >
                <div className="sticky flex flex-col md:flex-row z- items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
